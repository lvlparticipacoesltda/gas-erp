...
import { api, getCurrentStoreId, getStoredUser, getToken, setAuth } from '@/lib/api';
...
export default function SettingsPage() {
  ...
  const isMasterContext =
    (stored?.role === 'ORG_MASTER' || stored?.role === 'PLATFORM_ADMIN') && !storeId;
  const mode = isMasterContext ? 'master' : 'store';
