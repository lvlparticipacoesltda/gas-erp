...
> **Observação para publicação:** substitua os campos entre colchetes pelos dados do
> controlador antes de publicar na Play Store. A URL pública desta política deve ser
> informada na ficha da loja (campo "Política de Privacidade") e no formulário de
> Segurança de Dados.

- **Controlador dos dados:** [Razão social da empresa publicadora]
- **Contato (DPO/encarregado):** [email de contato] — [telefone]
...
- ocorre em primeiro e em segundo plano (com o app minimizado ou a tela bloqueada),
  exibindo uma notificação persistente enquanto está ativa;
- é **encerrada automaticamente** quando o entregador conclui a entrega ou faz logout;
- só acontece após o consentimento explícito apresentado no aplicativo (divulgação
  destacada) e a concessão da permissão do sistema operacional.
...
operação logística. **Não vendemos** dados pessoais nem os usamos para publicidade.
